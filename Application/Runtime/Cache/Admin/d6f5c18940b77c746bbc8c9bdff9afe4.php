...
<!--						<i class="fa fa-paw"></i>-->
    ...
    <div class="row tile_count">
        ...
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <span class="count_top"><i class="fa fa-bicycle"></i> <?php echo ($id); ?>历史停放车辆数 </span>
    ...
    <a href="<?php echo U('Admin/Bparking/infobikesall3',array('id'=>$id));?>">查看详情</a>

	<!--<a href="<?php echo U('Admin/Bparking/infobikesall2');?>">查看详情</a>-->
