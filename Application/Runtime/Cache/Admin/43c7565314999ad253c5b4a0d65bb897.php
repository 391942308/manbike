...
<img src="/manbike0.3/Public/images/bike_logo.png" style="width: 33px;margin-bottom: 5px;margin-left: 8px;"/>
	...
	<div class="row tile_count">
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-bicycle"></i>P<?php echo ($id); ?>实时停放车辆数 </span>
              <div class="count"><?php echo ($exist); ?></div>
              <span class="count_bottom"><i id="showintval" class="green"><?php echo ($msg); ?></i> </span>
			  <input id="interval" type="hidden" value="<?php echo ($interval); ?>" />
            </div>
	...
	<a id="zdsx" href="javascript:void(0);" type="button" class="btn btn-primary xx">自动刷新</a>
	<div id="zdsx_panel" style="display:none;">
		<a id="0" href="javascript:void(0);"  type="button" class="btn btn-primary intval">off</a>
		<a id="5" href="javascript:void(0);"  type="button" class="btn btn-primary intval">5s</a>
		<a id="10" href="javascript:void(0);"  type="button" class="btn btn-primary intval">10s</a>
		<a id="30" href="javascript:void(0);"  type="button" class="btn btn-primary intval">30s</a>
		<a id="60" href="javascript:void(0);"  type="button" class="btn btn-primary intval">1m</a>
		<a id="300" href="javascript:void(0);"  type="button" class="btn btn-primary intval">5m</a>
	</div>
	...
	<table class="table table-striped jambo_table bulk_action">
                                    ...
                                    <tbody>
									<?php if(is_array($arr_exist)): $i = 0; $__LIST__ = $arr_exist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="even pointer">
                                            <td class="a-center ">
...
//var test = genData(50);
		...
		option = {
			title : {
				text: 'P<?php echo ($id); ?>实时车位各个公司单车数量',
				//subtext: '纯属虚构',
				x:'left'
			},
			tooltip : {
	...
	<script>
		...
		var intvalid = 0;
		var url = "<?php echo U('/Admin/Bparking/infobikesexist');?>";
