                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div style="margin-bottom: 10px" class="input-group">
                                <form method="GET" action="<?php echo U('Admin/Bcompany/index');?>">
                                    <input id="name" type="text" class="form-control" style="width: 150px" placeholder="车企名称" name="title" value="<?php echo ($title); ?>"/>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped jambo_table bulk_action">
                                    ...
                                    <?php if(is_array($a_menu_list)): $i = 0; $__LIST__ = $a_menu_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="even pointer">
                                            ...
                                            <td class=" "><?php echo ($vo["color"]); ?> </td>
                                            <td class=" last">
                                                <a href="#">
                                                    <a href="javascript:;" navId="<?php echo ($vo['id']); ?>" navTitle="<?php echo ($vo['title']); ?>" navKeyword="<?php echo ($vo['keyword']); ?>" navColor="<?php echo ($vo['color']); ?>" onclick="edit(this)">修改</a>
                                                    |<a href="javascript:if(confirm('确定删除？'))location='<?php echo U('Admin/Bcompany/delete',array('id'=>$vo['id']));?>'">删除</a>
                                                </a>
                                            </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="bjy-form" class="form-inline" action="<?php echo U('Admin/Bcompany/add');?>" method="post">
    ...
    <div class="modal fade" id="bjy-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="bjy-form" class="form-inline" action="<?php echo U('Admin/Bcompany/edit');?>" method="post">
