...
<img src="/manbike0.3/Public/images/bike_logo.png" style="width: 33px;margin-bottom: 5px;margin-left: 8px;"/>
	...
	<div class="row tile_count">
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <div class="count"><?php echo ($ttimes); ?></div>
              <!--<span class="count_bottom"><i class="green">4% </i> </span>-->
            </div>
			<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-bicycle"></i> 总共采集到的次数 </span>
              <div class="count"><?php echo ($times); ?></div>
              <!--<span class="count_bottom"><i class="green">4% </i> </span>-->
            </div>
			<!--<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-bicycle"></i> 当前条件最大连续次数 </span>
              <div class="count"><?php echo ($max); ?></div>
              
            </div>
			<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-bicycle"></i> 监测到最大停放时间 </span>
              <div class="count"><?php echo ($ltime); ?>秒</div>
	...
	<div style="margin-bottom: 10px" class="input-group">
                                <form method="get" action="/manbike0.3/index.php/Admin/Bparking/infobikedetail">
										...
										<input name="start" id="start" class="form-control" size="16" type="text" placeholder="起始时间" value="<?php echo ($showstart); ?>" readonly>
										<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
										<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
									</div>
		                            <input type="text" class="form-control" style="width: 250px" placeholder="距离结束时长单位:分" name="still" value="<?php echo ($st); ?>" id="still">&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="text" class="form-control" style="width: 250px" placeholder="X时间间隔单位:秒" name="jiange" value="<?php echo ($jiange); ?>" id="intval">&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="hidden" class="form-control" style="width: 150px" name="id" value="<?php echo ($id); ?>" id="id">&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="hidden" class="form-control" style="width: 150px" name="mac" value="<?php echo ($mac); ?>" id="mac">&nbsp;&nbsp;&nbsp;&nbsp;
       ...
       <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="bjy-form" class="form-inline" action="<?php echo U('Admin/Bparking/infobikedetail');?>" method="post">
