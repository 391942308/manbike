...
<img src="/manbike0.3/Public/images/bike_logo.png" style="width: 33px;margin-bottom: 5px;margin-left: 8px;"/>
	...
	<div class="row tile_count">
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-bicycle"></i> <?php echo ($title); ?>区块历史停放 </span>
	...
	<!--<span><a href="http://116.62.171.54:8080/manbike0.3/index.php/Admin/Bparking/infobikesall2/id/<?php echo ($id); ?>">查看详情列表</a></span>-->
	<!--
