                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div style="margin-bottom: 10px" class="input-group">
                                <form method="POST" action="<?php echo U('Admin/Blast/index');?>">
                                    <input id="dwz_info_id" type="text" class="form-control" style="width: 150px" placeholder="车位编号" name="dwz_info_id" value="<?php echo ($dwz_info_id); ?>"/>
                                    <input id="jiange" type="text" class="form-control" style="width: 150px" placeholder="时间间隔" name="jiange" value="<?php echo ($jiange); ?>"/>
                                    <input id="start" type="text" class="form-control" style="width: 150px" placeholder="开始时间" name="start" value="<?php echo ($start); ?>"/>
                                    <input id="st" type="text" class="form-control" style="width: 150px" placeholder="持续时间" name="st" value="<?php echo ($st); ?>"/>
                                    <input id="judge" type="text" class="form-control" style="width: 150px" placeholder="允许的时间间隔" name="judge" value="<?php echo ($judge); ?>"/>
                                    <input id="rule" type="text" class="form-control" style="width: 150px" placeholder="规则" name="rule" value="<?php echo ($rule); ?>"/>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped jambo_table bulk_action">
                                    ...
                                    <tbody>
                                    <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="even pointer">
                                            <td class="a-center ">
