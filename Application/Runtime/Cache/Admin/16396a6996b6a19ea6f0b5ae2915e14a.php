...
<!--
                            ...
                            <div style="margin-bottom: 10px" class="input-group">
                                <form method="GET" action="<?php echo U('Admin/Bike/index');?>">
                                    <input id="name" type="text" class="form-control" style="width: 150px" placeholder="车辆名称" name="name" value="<?php echo ($name); ?>"/>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped jambo_table bulk_action">
                                    ...
                                    <?php if(is_array($a_menu_list)): $i = 0; $__LIST__ = $a_menu_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="even pointer">
                                            ...
                                            <td class=" "><?php echo ($vo); ?></td>
                                            <td class=" last">
                                                <a href="#">
                                                    <a id="<?php echo ($vo); ?>" class="xq" href="javascript:void(0)">详情</a>
