                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div style="margin-bottom: 10px" class="input-group">
                                <form method="POST" action="<?php echo U('Admin/Blast/oneblock');?>">
							...
							<input id="bid" type="text" class="form-control" style="width: 250px" placeholder="社区名称" name="bid" value="<?php echo ($bid); ?>"/>
