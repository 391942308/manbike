...
<!--						<i class="fa fa-paw"></i>-->
    ...
    <link href="/Public/myjslib/css/bootstrap-datetimepicker.min.css" rel="stylesheet" media="screen">
...
//        }
	...
	<script type="text/javascript" src="/Public/myjslib/jquery/jquery-1.8.3.min.js" charset="UTF-8"></script>
	<script type="text/javascript" src="/Public/myjslib/bootstrap/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="/Public/myjslib/js/bootstrap-datetimepicker.js" charset="UTF-8"></script>
	<script type="text/javascript" src="/Public/myjslib/js/locales/bootstrap-datetimepicker.fr.js" charset="UTF-8"></script>
	<script type="text/javascript">
