                            ...
                            <div class="table-responsive">
                                <table class="table table-striped jambo_table bulk_action">
                                    ...
                                    <?php if(is_array($a_menu_list)): $i = 0; $__LIST__ = $a_menu_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="even pointer">
                                            ...
                                            <td class=" "><?php echo ($vo["bike_company"]); ?></td>
                                            <td class=" "><?php echo ($vo["dwz_info_id"]); ?> </td>
                                            <td class=" "><?php echo ($vo["dwz_info_title"]); ?> </td>
                                            <td class=" "><?php echo ($vo["lng"]); ?> </td>
                                            <td class="a-right a-right "><?php echo ($vo["lat"]); ?></td>
                                            <td class=" last">
                                                <a href="#">
                                                     <a href="javascript:if(confirm('确定删除？'))location='<?php echo U('Admin/Bikesub/delete',array('id'=>$vo['id']));?>'">删除</a>
                                                </a>
                                            </td>
